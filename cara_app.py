...
- Top 3 most relevant notes from MTSamples knowledge base
...
st.caption("Corrected file with Streamlit secrets support.")
st.write("This corrected version fixes the broken f-string and reads your Gemini API key from Streamlit secrets.")
